...
class Translations {
    companion object {
        val ACTUAL_TO_HUMAN_READABLE: Map<String, String> = mapOf(
            ...
            "avg_cycles" to "Avg Cycles",
            "sd_cycles" to "SD Cycles",
            "max_cycles" to "Max Cycles",
            "lfm_avg_cycles" to "Avg Cycles",
            "lfm_sd_cycles" to "SD Cycles",
            "lfm_max_cycles" to "Max Cycles",
            ...
            "tele_dock" to "Docking",
            "tele_park" to "Parking",
            "tele_engage" to "Engaging",
            ...
            "lfm_auto_dock" to "Docking",
            "lfm_auto_engage" to "Engaging",
            "lfm_tele_avg_low" to "Avg Low",
            ...
            "lfm_tele_dock" to "Docking",
            "lfm_tele_engage" to "Engaging",
