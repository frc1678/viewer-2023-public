...
class Constants {
    companion object {
        ...
        val RANKABLE_FIELDS = mapOf<String, Boolean>(
            ...
            "auto_avg_gamepiece_low" to true,
            ...
            "tele_avg_gamepiece_low" to true,
            ...
            "lfm_tele_avg_gamepiece_low" to true,
            ...
            "lfm_auto_avg_gamepiece_low" to true,
            ...
            "max_gamepieces" to true,
            "avg_gamepieces" to true,
            "sd_gamepieces" to true,
            "lfm_max_gamepieces" to true,
            "lfm_avg_gamepieces" to true,
            "scored_coop" to true
        )
