...
class DatabaseReference {
    ...
    data class CalculatedObjectiveTeam (
        var team_number: Int,
        var auto_avg_hub_balls_high: Float,
        var auto_avg_other_balls_high: Float,
        var auto_avg_low_balls: Float,
        var tele_avg_hub_balls_high: Float,
        var tele_avg_other_balls_high: Float,
        ...
        var lfm_auto_avg_hub_balls_high: Float,
        var lfm_auto_avg_other_balls_high: Float,
        var lfm_tele_avg_hub_balls_high: Float,
        var lfm_tele_avg_other_balls_high: Float,
    ...
    data class CalculatedObjectiveTeamInMatch (
        ...
        var team_number: Int,
        var match_number: Int,
        var auto_hub_balls_high: Int,
        var auto_other_balls_high: Int,
        var auto_low_balls: Int,
        var auto_total_balls: Int,
        var tele_hub_balls_high: Int,
        var tele_other_balls_high: Int,
