...
object DatabaseReference {
    ...
    data class CompetitionObject(
        var raw_obj_pit: MutableList<DataCollection.ObjectivePit> = mutableListOf(),
        var obj_tim: MutableList<DataCollection.CalculatedObjectiveTeamInMatch> = mutableListOf(),
        var obj_team: MutableList<DataCollection.CalculatedObjectiveTeam> = mutableListOf(),
        var subj_team: MutableList<DataCollection.CalculatedSubjectiveTeam> = mutableListOf(),
        var predicted_aim: MutableList<DataCollection.CalculatedPredictedAllianceInMatch> = mutableListOf(),
        var predicted_team: MutableList<DataCollection.CalculatedPredictedTeam> = mutableListOf(),
        var tba_team: MutableList<DataCollection.CalculatedTBATeam> = mutableListOf(),
        var pickability: MutableList<DataCollection.CalculatedPickAbilityTeam> = mutableListOf(),
        var tba_tim: MutableList<DataCollection.CalculatedTBATeamInMatch> = mutableListOf(),
        var picklist: MutableList<DataCollection.PicklistTeam> = mutableListOf(),
        var subj_tim: MutableList<DataCollection.CalculatedSubjectiveTeamInMatch> = mutableListOf()
    )
    @Serializable
