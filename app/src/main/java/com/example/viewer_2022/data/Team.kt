...
data class Team (var team_number: Int?) {
    ...
    var auto_avg_hub_balls_high: Float? = null
    var auto_avg_launchpad_balls_high: Float? = null
    var auto_avg_other_balls_high: Float? = null
    var auto_avg_total_balls: Float? = null
    var tele_avg_low_balls: Float? = null
    var tele_avg_high_balls: Float? = null
    var tele_avg_hub_balls_high: Float? = null
    var tele_avg_other_balls_high: Float? = null
