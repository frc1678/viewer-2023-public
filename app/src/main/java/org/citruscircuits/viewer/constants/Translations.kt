...
class Translations {
    companion object {
        val ACTUAL_TO_HUMAN_READABLE: Map<String, String> = mapOf(
            ...
            "auto_total_gamepieces" to "Total Game Pieces",
            ...
            "intakes_double" to "Double Station Intakes",
            "intakes_single" to "Single Station Intakes",
            "length" to "Length (in.)",
            ...
            "avg_intakes_double" to "Avg Double Station Intakes",
            "avg_intakes_single" to "Avg Single Station Intakes",
